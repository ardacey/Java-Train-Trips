...
public class TripController implements ArrivalController, DepartureController {
    ...
    public TripController(TripSchedule trip_schedule, String outputPath) {
    ...
    public void DepartureSchedule(TripSchedule trip_schedule){
        ...
        Io.writeToFile(outputPath, "Departure order:", true, true);
        ...
        trip_schedule.printDepartureSchedule(outputPath);
    }
    ...
    public void ArrivalSchedule(TripSchedule trip_schedule) {
        ...
        trip_schedule.printArrivalSchedule(outputPath);
    }
}